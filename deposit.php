...
<body class="overlay">
    ...
    <section class="section is-medium">
        ...
        <div class="column is-6 py-6">
            <h1 class="title is-2 has-text-light">Deposit</h1>
                ...
                <div class="div-centered">
                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" autocomplete="off">
                        <div class="row text-center">
                            ...
                            <input type="submit" name="submit" value="Fund Transfer" class="button is-success is-light has-text-weight-bold" style="font-size: 20px">
